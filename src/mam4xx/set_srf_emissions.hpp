#ifndef MAM4XX_SET_SRF_EMISSSIONS_HPP
#define MAM4XX_SET_SRF_EMISSSIONS_HPP
...
const Real amufac = 1.65979e-23; // 1.e4* kg / amu
...
// void srf_emissions_inti(srf_emis_specifier, emis_type, emis_cycle_yr,
...
KOKKOS_INLINE_FUNCTION
void set_srf_emissions(Real sflx[pcnst]) {
  //--------------------------------------------------------
